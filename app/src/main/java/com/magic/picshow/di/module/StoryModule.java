...
import com.magic.picshow.mvp.model.StoryModel;
...
public class StoryModule {
    ...
    /**
     * 构建StoryModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    StoryContract.View provideStoryView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    StoryContract.Model provideStoryModel(StoryModel model) {
        return model;
    }
}