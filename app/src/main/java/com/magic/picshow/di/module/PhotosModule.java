...
import com.magic.picshow.mvp.model.PhotosModel;
...
public class PhotosModule {
    ...
    /**
     * 构建PhotosModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @FragmentScope
    @Provides
    PhotosContract.View providePhotosView() {
        return this.view;
    }

    @FragmentScope
    @Provides
    PhotosContract.Model providePhotosModel(PhotosModel model) {
        return model;
    }
}