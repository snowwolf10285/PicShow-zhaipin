...
public class HomeModel extends BaseModel<ServiceManager, CacheManager> implements HomeContract.Model {
    ...
    @Override
    public Observable<BaseJson<List<Classify>>> getClassifyList() {
        Observable<BaseJson<List<Classify>>> classifyList = mServiceManager.getCommonService().getClassifyList();
        return classifyList;
    }
