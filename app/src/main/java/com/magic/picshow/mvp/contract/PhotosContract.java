...
public interface PhotosContract {
    ...
    interface View extends BaseView {
        ...
        void startLoadMore();
        void endLoadMore();
        void isLoadAllItems(boolean isLoadAll);
        //申请权限
    ...
    interface Model extends IModel {
        //classify_id= 0查全部,type＝0普通，1同城，2购买的
        Observable<BaseJson<Photos>> getPhotosList(int classify_id,int type,int page, int rows,int user_id);
    }
}