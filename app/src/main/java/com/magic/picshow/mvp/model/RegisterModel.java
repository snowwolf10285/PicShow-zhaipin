...
public class RegisterModel extends BaseModel<ServiceManager, CacheManager> implements RegisterContract.Model {
    ...
    @Override
    public Observable<BaseJson<LoginInfo>> register(String account, String password, String code) {
        HashMap params = new HashMap();
        params.put("account", account);
        params.put("password", password);
        params.put("code", code);
        Observable<BaseJson<LoginInfo>> loginInfo = mServiceManager.getLoginService().register(params);
        return loginInfo;
    }

    @Override
    public Observable<BaseJson<LoginInfo>> updatePassword(String account, String password, String code) {
        HashMap params = new HashMap();
        params.put("account", account);
        params.put("password", password);
        params.put("code", code);
        Observable<BaseJson<LoginInfo>> loginInfo = mServiceManager.getLoginService().updatePassword(params);
        return loginInfo;
    }
}