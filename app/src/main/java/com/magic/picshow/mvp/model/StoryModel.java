...
@ActivityScope
public class StoryModel extends BaseModel<ServiceManager, CacheManager> implements StoryContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public StoryModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
