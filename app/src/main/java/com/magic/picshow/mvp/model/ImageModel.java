...
@ActivityScope
public class ImageModel extends BaseModel<ServiceManager, CacheManager> implements ImageContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public ImageModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
