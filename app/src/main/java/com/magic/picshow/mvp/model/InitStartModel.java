...
@ActivityScope
public class InitStartModel extends BaseModel<ServiceManager, CacheManager> implements InitStartContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public InitStartModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
